...
public class Relational {
    public static void main(String[] args) {
        ...
        System.out.println(10 >= 8); // greater or equal so it is greater ==> true

        System.out.println(9 >= 9); // greater or equal so its equal, it will give you ==> true
        ...
        System.out.println("Farsi language" != "Azari language");  //true
