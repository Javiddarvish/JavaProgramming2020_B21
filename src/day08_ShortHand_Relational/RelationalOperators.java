...
public class RelationalOperators {
    ...
    boolean r1 = num1 > num2;  // num1 is grater than num2
    boolean r2 = num2 > num1;  //  num2 is greater than num1

    boolean r3 = num1 < num2;  // num1 is less than num2
    boolean r4 = num2 < num1;  // num 2 is less than num1
        ...
        boolean b5 = "Javid" == "Good Guy"; // false
        System.out.println(b5);

        boolean b6 = "Javid" != "Good Guy"; // true
